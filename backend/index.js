...
mongoose
  .connect(
    "mongodb+srv://sam200012:samsan20001218@cluster0.bleti.mongodb.net/shopping_cart?retryWrites=true&w=majority&appName=Cluster0",
    {
...
app.post('/signup',async(req,res)=>{
    ...
    if(check){
        return res.status(4000).json({success:false,errors:"existing user found with the same email id"})
    }
